...
const DEFAULT_SETTINGS: SiteSettings = {
  ...
  heroSubtitleTr: "Genel dis hekimligi, estetik uygulamalar ve koruyucu bakim sureclerinde size ozenli ve anlasilir bir tedavi deneyimi sunuyoruz.",
  heroSubtitleEn: "We provide attentive and transparent care across general dentistry, aesthetic treatments, and preventive oral health services.",
  ...
  seoTitleTr: "Adakan",
  seoTitleEn: "Adakan",
  seoDescTr: "Adakan dis klinigi; muayene, estetik uygulamalar ve koruyucu bakim hizmetleri icin randevu olusturabileceginiz resmi klinik sitesidir.",
